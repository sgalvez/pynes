...
```text
Commit build version: 1.0.2.dev42+gabc1234
Formal release version: 1.0.2
...
```bash
python -m pip install pynes-1.0.2-py3-none-any.whl
```
...
Set `tag_name` to the release tag, for example `v1.0.2`, and keep
